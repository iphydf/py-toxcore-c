...
class Tox_Err_File_By_Id(enum.Enum):
...
class Tox_Err_Group_By_Id(enum.Enum):
...
class Tox_Ptr:
    ...
    group_group_list: list[Tox_Group_Number]
    ...
    def handle_conference_invite(self, friend_number: Tox_Friend_Number, type: Tox_Conference_Type, cookie: bytes) -> None: ...
    def handle_conference_message(self, conference_number: Tox_Conference_Number, peer_number: Tox_Conference_Peer_Number, type: Tox_Message_Type, message: bytes) -> None: ...
    ...
    def handle_friend_message(self, friend_number: Tox_Friend_Number, type: Tox_Message_Type, message: bytes) -> None: ...
