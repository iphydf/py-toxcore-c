...
cdef extern from "tox/tox.h":
    ...
    ctypedef void tox_log_cb(Tox* tox, Tox_Log_Level level, const char* file, uint32_t line, const char* func, const char* message, void* user_data) except *
    ctypedef void tox_self_connection_status_cb(Tox* tox, Tox_Connection connection_status, void* user_data) except *
    ctypedef void tox_friend_name_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* name, size_t length, void* user_data) except *
    ctypedef void tox_friend_status_message_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* message, size_t length, void* user_data) except *
    ...
    ctypedef void tox_friend_request_cb(Tox* tox, const uint8_t* public_key, const uint8_t* message, size_t length, void* user_data) except *
    ctypedef void tox_friend_message_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_Message_Type type_, const uint8_t* message, size_t length, void* user_data) except *
    ctypedef void tox_friend_lossy_packet_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* data, size_t length, void* user_data) except *
    ctypedef void tox_friend_lossless_packet_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* data, size_t length, void* user_data) except *
    ...
    ctypedef void tox_file_recv_chunk_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_File_Number file_number, uint64_t position, const uint8_t* data, size_t length, void* user_data) except *
    ctypedef void tox_conference_peer_name_cb(Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number peer_number, const uint8_t* name, size_t length, void* user_data) except *
    ctypedef void tox_conference_peer_list_changed_cb(Tox* tox, Tox_Conference_Number conference_number, void* user_data) except *
    ctypedef void tox_conference_invite_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_Conference_Type type_, const uint8_t* cookie, size_t length, void* user_data) except *
    ...
    cdef Tox_Friend_Message_Id tox_friend_send_message(Tox* self, Tox_Friend_Number friend_number, Tox_Message_Type type_, const uint8_t* message, size_t length, Tox_Err_Friend_Send_Message* error)
    ...
    cdef bool tox_conference_send_message(Tox* self, Tox_Conference_Number conference_number, Tox_Message_Type type_, const uint8_t* message, size_t length, Tox_Err_Conference_Send_Message* error)
