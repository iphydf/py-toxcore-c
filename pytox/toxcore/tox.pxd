...
cdef extern from "tox/tox.h":
    ...
    cpdef enum Tox_Err_Group_By_Id:
    ...
    cpdef enum Tox_Err_Group_Kick_Peer:
    ...
    cpdef enum Tox_Err_Group_Set_Password:
    ...
    cpdef enum Tox_Err_Group_Set_Peer_Limit:
    ...
    cpdef enum Tox_Err_Group_Set_Privacy_State:
    ...
    cpdef enum Tox_Err_Group_Set_Role:
    ...
    cpdef enum Tox_Err_Group_Set_Topic_Lock:
    ...
    cpdef enum Tox_Err_Group_Set_Voice_State:
    ...
    ctypedef void tox_conference_connected_cb(Tox* tox, Tox_Conference_Number conference_number, void* user_data) except *
    ctypedef void tox_conference_invite_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_Conference_Type type, const uint8_t* cookie, size_t cookie_length, void* user_data) except *
    ctypedef void tox_conference_message_cb(Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number peer_number, Tox_Message_Type type, const uint8_t* message, size_t message_length, void* user_data) except *
    ctypedef void tox_conference_peer_list_changed_cb(Tox* tox, Tox_Conference_Number conference_number, void* user_data) except *
    ctypedef void tox_conference_peer_name_cb(Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number peer_number, const uint8_t* name, size_t name_length, void* user_data) except *
    ctypedef void tox_conference_title_cb(Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number peer_number, const uint8_t* title, size_t title_length, void* user_data) except *
    ctypedef void tox_file_chunk_request_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_File_Number file_number, uint64_t position, size_t length, void* user_data) except *
    ctypedef void tox_file_recv_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_File_Number file_number, uint32_t kind, uint64_t file_size, const uint8_t* filename, size_t filename_length, void* user_data) except *
    ctypedef void tox_file_recv_chunk_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_File_Number file_number, uint64_t position, const uint8_t* data, size_t data_length, void* user_data) except *
    ctypedef void tox_file_recv_control_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_File_Number file_number, Tox_File_Control control, void* user_data) except *
    ctypedef void tox_friend_connection_status_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_Connection connection_status, void* user_data) except *
    ctypedef void tox_friend_lossless_packet_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* data, size_t data_length, void* user_data) except *
    ctypedef void tox_friend_lossy_packet_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* data, size_t data_length, void* user_data) except *
    ctypedef void tox_friend_message_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_Message_Type type, const uint8_t* message, size_t message_length, void* user_data) except *
    ctypedef void tox_friend_name_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* name, size_t name_length, void* user_data) except *
    ctypedef void tox_friend_read_receipt_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_Friend_Message_Id message_id, void* user_data) except *
    ctypedef void tox_friend_request_cb(Tox* tox, const uint8_t* public_key, const uint8_t* message, size_t message_length, void* user_data) except *
    ctypedef void tox_friend_status_cb(Tox* tox, Tox_Friend_Number friend_number, Tox_User_Status status, void* user_data) except *
    ctypedef void tox_friend_status_message_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* message, size_t message_length, void* user_data) except *
    ctypedef void tox_friend_typing_cb(Tox* tox, Tox_Friend_Number friend_number, bool typing, void* user_data) except *
    ...
    ctypedef void tox_group_invite_cb(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* invite_data, const uint8_t* group_name, void* user_data) except *
    ...
    ctypedef void tox_group_peer_exit_cb(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, Tox_Group_Exit_Type exit_type, const uint8_t* name, const uint8_t* part_message, void* user_data) except *
    ...
    ctypedef void tox_log_cb(Tox* tox, Tox_Log_Level level, const char* file, size_t file_length, uint32_t line, const char* func, const char* message, void* user_data) except *
    ctypedef void tox_self_connection_status_cb(Tox* tox, Tox_Connection connection_status, void* user_data) except *
    cdef uint32_t tox_conference_uid_size()
    cdef uint32_t tox_conference_id_size()
    cdef Tox_Conference_Number tox_conference_new(Tox* tox, Tox_Err_Conference_New* error)
    cdef bool tox_conference_delete(Tox* tox, Tox_Conference_Number conference_number, Tox_Err_Conference_Delete* error)
    cdef uint32_t tox_conference_peer_count(const Tox* tox, Tox_Conference_Number conference_number, Tox_Err_Conference_Peer_Query* error)
    cdef uint32_t tox_conference_offline_peer_count(const Tox* tox, Tox_Conference_Number conference_number, Tox_Err_Conference_Peer_Query* error)
    cdef bool tox_conference_set_max_offline(Tox* tox, Tox_Conference_Number conference_number, uint32_t max_offline, Tox_Err_Conference_Set_Max_Offline* error)
    cdef Tox_Conference_Number tox_conference_join(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* cookie, size_t cookie_len, Tox_Err_Conference_Join* error)
    cdef bool tox_conference_send_message(Tox* tox, Tox_Conference_Number conference_number, Tox_Message_Type type, const uint8_t* message, size_t message_len, Tox_Err_Conference_Send_Message* error)
    cdef size_t tox_conference_get_title_size(const Tox* tox, Tox_Conference_Number conference_number, Tox_Err_Conference_Title* error)
    cdef bool tox_conference_get_title(const Tox* tox, Tox_Conference_Number conference_number, uint8_t* data, Tox_Err_Conference_Title* error)
    cdef bool tox_conference_set_title(Tox* tox, Tox_Conference_Number conference_number, const uint8_t* title, size_t title_len, Tox_Err_Conference_Title* error)
    cdef Tox_Conference_Type tox_conference_get_type(const Tox* tox, Tox_Conference_Number conference_number, Tox_Err_Conference_Get_Type* error)
    cdef bool tox_conference_get_id(const Tox* tox, Tox_Conference_Number conference_number, uint8_t* data)
    cdef Tox_Conference_Number tox_conference_by_id(const Tox* tox, const uint8_t* id, Tox_Err_Conference_By_Id* error)
    cdef size_t tox_conference_offline_peer_get_name_size(const Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Offline_Peer_Number conference_offline_peer_number, Tox_Err_Conference_Peer_Query* error)
    cdef bool tox_conference_offline_peer_get_name(const Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Offline_Peer_Number conference_offline_peer_number, uint8_t* data, Tox_Err_Conference_Peer_Query* error)
    cdef bool tox_conference_offline_peer_get_public_key(const Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Offline_Peer_Number conference_offline_peer_number, uint8_t* data, Tox_Err_Conference_Peer_Query* error)
    cdef uint64_t tox_conference_offline_peer_get_last_active(const Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Offline_Peer_Number conference_offline_peer_number, Tox_Err_Conference_Peer_Query* error)
    cdef size_t tox_conference_peer_get_name_size(const Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number conference_peer_number, Tox_Err_Conference_Peer_Query* error)
    cdef bool tox_conference_peer_get_name(const Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number conference_peer_number, uint8_t* data, Tox_Err_Conference_Peer_Query* error)
    cdef bool tox_conference_peer_get_public_key(const Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number conference_peer_number, uint8_t* data, Tox_Err_Conference_Peer_Query* error)
    cdef bool tox_conference_peer_number_is_ours(const Tox* tox, Tox_Conference_Number conference_number, Tox_Conference_Peer_Number conference_peer_number, Tox_Err_Conference_Peer_Query* error)
    cdef uint32_t tox_file_id_length()
    cdef Tox_File_Number tox_file_by_id(const Tox* tox, Tox_Friend_Number friend_number, const uint8_t* file_id, Tox_Err_File_By_Id* error)
    cdef Tox_File_Number tox_file_send(Tox* tox, Tox_Friend_Number friend_number, uint32_t kind, uint64_t file_size, const uint8_t* file_id, const uint8_t* filename, size_t filename_len, Tox_Err_File_Send* error)
    cdef Tox_Friend_Number tox_friend_add(Tox* tox, const uint8_t* address, const uint8_t* message, size_t message_len, Tox_Err_Friend_Add* error)
    cdef Tox_Friend_Number tox_friend_add_norequest(Tox* tox, const uint8_t* public_key, Tox_Err_Friend_Add* error)
    cdef bool tox_friend_delete(Tox* tox, Tox_Friend_Number friend_number, Tox_Err_Friend_Delete* error)
    cdef Tox_Friend_Number tox_friend_by_public_key(const Tox* tox, const uint8_t* public_key, Tox_Err_Friend_By_Public_Key* error)
    cdef bool tox_friend_exists(const Tox* tox, Tox_Friend_Number friend_number)
    cdef bool tox_friend_get_public_key(const Tox* tox, Tox_Friend_Number friend_number, uint8_t* data, Tox_Err_Friend_Get_Public_Key* error)
    cdef uint64_t tox_friend_get_last_online(const Tox* tox, Tox_Friend_Number friend_number, Tox_Err_Friend_Get_Last_Online* error)
    cdef size_t tox_friend_get_name_size(const Tox* tox, Tox_Friend_Number friend_number, Tox_Err_Friend_Query* error)
    cdef bool tox_friend_get_name(const Tox* tox, Tox_Friend_Number friend_number, uint8_t* data, Tox_Err_Friend_Query* error)
    cdef size_t tox_friend_get_status_message_size(const Tox* tox, Tox_Friend_Number friend_number, Tox_Err_Friend_Query* error)
    cdef bool tox_friend_get_status_message(const Tox* tox, Tox_Friend_Number friend_number, uint8_t* data, Tox_Err_Friend_Query* error)
    cdef Tox_User_Status tox_friend_get_status(const Tox* tox, Tox_Friend_Number friend_number, Tox_Err_Friend_Query* error)
    cdef Tox_Connection tox_friend_get_connection_status(const Tox* tox, Tox_Friend_Number friend_number, Tox_Err_Friend_Query* error)
    cdef bool tox_friend_get_typing(const Tox* tox, Tox_Friend_Number friend_number, Tox_Err_Friend_Query* error)
    cdef Tox_Friend_Message_Id tox_friend_send_message(Tox* tox, Tox_Friend_Number friend_number, Tox_Message_Type type, const uint8_t* message, size_t message_len, Tox_Err_Friend_Send_Message* error)
    cdef bool tox_friend_send_lossy_packet(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* data, size_t data_len, Tox_Err_Friend_Custom_Packet* error)
    cdef bool tox_friend_send_lossless_packet(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* data, size_t data_len, Tox_Err_Friend_Custom_Packet* error)
    ...
    cdef Tox_Group_Number tox_group_new(Tox* tox, Tox_Group_Privacy_State privacy_state, const uint8_t* group_name, size_t group_name_len, const uint8_t* name, size_t name_len, Tox_Err_Group_New* error)
    cdef Tox_Group_Number tox_group_join(Tox* tox, const uint8_t* chat_id, const uint8_t* name, size_t name_len, const uint8_t* password, size_t password_len, Tox_Err_Group_Join* error)
    cdef bool tox_group_is_connected(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_Is_Connected* error)
    cdef bool tox_group_disconnect(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_Disconnect* error)
    cdef bool tox_group_leave(Tox* tox, Tox_Group_Number group_number, const uint8_t* part_message, size_t part_message_len, Tox_Err_Group_Leave* error)
    cdef bool tox_group_self_set_name(Tox* tox, Tox_Group_Number group_number, const uint8_t* name, size_t name_len, Tox_Err_Group_Self_Name_Set* error)
    cdef size_t tox_group_self_get_name_size(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_Self_Query* error)
    cdef bool tox_group_self_get_name(const Tox* tox, Tox_Group_Number group_number, uint8_t* data, Tox_Err_Group_Self_Query* error)
    cdef bool tox_group_self_set_status(Tox* tox, Tox_Group_Number group_number, Tox_User_Status status, Tox_Err_Group_Self_Status_Set* error)
    cdef Tox_User_Status tox_group_self_get_status(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_Self_Query* error)
    cdef Tox_Group_Role tox_group_self_get_role(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_Self_Query* error)
    cdef Tox_Group_Peer_Number tox_group_self_get_peer_id(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_Self_Query* error)
    cdef bool tox_group_self_get_public_key(const Tox* tox, Tox_Group_Number group_number, uint8_t* data, Tox_Err_Group_Self_Query* error)
    cdef bool tox_group_set_topic(Tox* tox, Tox_Group_Number group_number, const uint8_t* topic, size_t topic_len, Tox_Err_Group_Topic_Set* error)
    cdef size_t tox_group_get_topic_size(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_State_Query* error)
    cdef bool tox_group_get_topic(const Tox* tox, Tox_Group_Number group_number, uint8_t* data, Tox_Err_Group_State_Query* error)
    cdef size_t tox_group_get_name_size(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_State_Query* error)
    cdef bool tox_group_get_name(const Tox* tox, Tox_Group_Number group_number, uint8_t* data, Tox_Err_Group_State_Query* error)
    cdef bool tox_group_get_chat_id(const Tox* tox, Tox_Group_Number group_number, uint8_t* data, Tox_Err_Group_State_Query* error)
    cdef Tox_Group_Number tox_group_by_id(const Tox* tox, const uint8_t* chat_id, Tox_Err_Group_By_Id* error)
    cdef Tox_Group_Privacy_State tox_group_get_privacy_state(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_State_Query* error)
    cdef Tox_Group_Voice_State tox_group_get_voice_state(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_State_Query* error)
    cdef Tox_Group_Topic_Lock tox_group_get_topic_lock(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_State_Query* error)
    cdef uint16_t tox_group_get_peer_limit(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_State_Query* error)
    cdef size_t tox_group_get_password_size(const Tox* tox, Tox_Group_Number group_number, Tox_Err_Group_State_Query* error)
    cdef bool tox_group_get_password(const Tox* tox, Tox_Group_Number group_number, uint8_t* data, Tox_Err_Group_State_Query* error)
    cdef Tox_Group_Message_Id tox_group_send_message(const Tox* tox, Tox_Group_Number group_number, Tox_Message_Type message_type, const uint8_t* message, size_t message_len, Tox_Err_Group_Send_Message* error)
    cdef Tox_Group_Message_Id tox_group_send_private_message(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, Tox_Message_Type message_type, const uint8_t* message, size_t message_len, Tox_Err_Group_Send_Private_Message* error)
    cdef bool tox_group_send_custom_packet(const Tox* tox, Tox_Group_Number group_number, bool lossless, const uint8_t* data, size_t data_len, Tox_Err_Group_Send_Custom_Packet* error)
    cdef bool tox_group_send_custom_private_packet(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, bool lossless, const uint8_t* data, size_t data_len, Tox_Err_Group_Send_Custom_Private_Packet* error)
    cdef bool tox_group_invite_friend(const Tox* tox, Tox_Group_Number group_number, Tox_Friend_Number friend_number, Tox_Err_Group_Invite_Friend* error)
    cdef Tox_Group_Number tox_group_invite_accept(Tox* tox, Tox_Friend_Number friend_number, const uint8_t* invite_data, size_t invite_data_len, const uint8_t* name, size_t name_len, const uint8_t* password, size_t password_len, Tox_Err_Group_Invite_Accept* error)
    cdef bool tox_group_set_password(Tox* tox, Tox_Group_Number group_number, const uint8_t* password, size_t password_len, Tox_Err_Group_Set_Password* error)
    cdef bool tox_group_set_topic_lock(Tox* tox, Tox_Group_Number group_number, Tox_Group_Topic_Lock topic_lock, Tox_Err_Group_Set_Topic_Lock* error)
    cdef bool tox_group_set_voice_state(Tox* tox, Tox_Group_Number group_number, Tox_Group_Voice_State voice_state, Tox_Err_Group_Set_Voice_State* error)
    cdef bool tox_group_set_privacy_state(Tox* tox, Tox_Group_Number group_number, Tox_Group_Privacy_State privacy_state, Tox_Err_Group_Set_Privacy_State* error)
    cdef bool tox_group_set_peer_limit(Tox* tox, Tox_Group_Number group_number, uint16_t peer_limit, Tox_Err_Group_Set_Peer_Limit* error)
    cdef bool tox_group_set_ignore(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, bool ignore, Tox_Err_Group_Set_Ignore* error)
    cdef bool tox_group_set_role(Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, Tox_Group_Role role, Tox_Err_Group_Set_Role* error)
    cdef bool tox_group_kick_peer(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number peer_id, Tox_Err_Group_Kick_Peer* error)
    cdef uint32_t tox_group_peer_public_key_size()
    cdef size_t tox_group_peer_get_name_size(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number group_peer_number, Tox_Err_Group_Peer_Query* error)
    cdef bool tox_group_peer_get_name(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number group_peer_number, uint8_t* data, Tox_Err_Group_Peer_Query* error)
    cdef Tox_User_Status tox_group_peer_get_status(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number group_peer_number, Tox_Err_Group_Peer_Query* error)
    cdef Tox_Group_Role tox_group_peer_get_role(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number group_peer_number, Tox_Err_Group_Peer_Query* error)
    cdef Tox_Connection tox_group_peer_get_connection_status(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number group_peer_number, Tox_Err_Group_Peer_Query* error)
    cdef bool tox_group_peer_get_public_key(const Tox* tox, Tox_Group_Number group_number, Tox_Group_Peer_Number group_peer_number, uint8_t* data, Tox_Err_Group_Peer_Query* error)
    ...
    cdef uint8_t* tox_options_get_savedata_data(const Tox_Options* self)
    cdef bool tox_options_set_savedata_data(Tox_Options* self, const uint8_t* savedata_data, size_t savedata_data_len)
    cdef size_t tox_options_get_savedata_length(const Tox_Options* self)
    cdef void tox_options_set_savedata_length(Tox_Options* self, size_t savedata_length)
    cdef tox_log_cb* tox_options_get_log_callback(const Tox_Options* self)
    cdef void tox_options_set_log_callback(Tox_Options* self, tox_log_cb* log_callback)
    cdef void* tox_options_get_log_user_data(const Tox_Options* self)
    cdef void tox_options_set_log_user_data(Tox_Options* self, void* log_user_data)
    ...
    cdef void tox_options_copy(Tox_Options* self, const Tox_Options* src)
    ...
    cdef void tox_get_savedata(const Tox* self, uint8_t* data)
    ...
    cdef void tox_iterate(Tox* self, void* user_data) except *
    cdef void tox_self_get_address(const Tox* self, uint8_t* data)
    cdef void tox_self_set_nospam(Tox* self, uint32_t nospam)
    cdef uint32_t tox_self_get_nospam(const Tox* self)
    cdef void tox_self_get_public_key(const Tox* self, uint8_t* data)
    cdef void tox_self_get_secret_key(const Tox* self, uint8_t* data)
    cdef bool tox_self_set_name(Tox* self, const uint8_t* name, size_t name_len, Tox_Err_Set_Info* error)
    cdef size_t tox_self_get_name_size(const Tox* self)
    cdef void tox_self_get_name(const Tox* self, uint8_t* data)
    cdef bool tox_self_set_status_message(Tox* self, const uint8_t* status_message, size_t status_message_len, Tox_Err_Set_Info* error)
    cdef size_t tox_self_get_status_message_size(const Tox* self)
    cdef void tox_self_get_status_message(const Tox* self, uint8_t* data)
    ...
    cdef void tox_self_get_friend_list(const Tox* self, Tox_Friend_Number* data)
    cdef bool tox_self_set_typing(Tox* self, Tox_Friend_Number friend_number, bool typing, Tox_Err_Set_Typing* error)
    cdef bool tox_hash(uint8_t* data, const uint8_t* data, size_t data_len)
    ...
    cdef bool tox_file_get_file_id(const Tox* self, Tox_Friend_Number friend_number, Tox_File_Number file_number, uint8_t* data, Tox_Err_File_Get* error)
    cdef bool tox_file_send_chunk(Tox* self, Tox_Friend_Number friend_number, Tox_File_Number file_number, uint64_t position, const uint8_t* data, size_t data_len, Tox_Err_File_Send_Chunk* error)
    ...
    cdef void tox_conference_get_chatlist(const Tox* self, Tox_Conference_Number* data)
    cdef void tox_self_get_dht_id(const Tox* self, uint8_t* data)
    ...
    cdef uint32_t tox_group_get_group_list_size(const Tox* self)
    cdef void tox_group_get_group_list(const Tox* self, Tox_Group_Number* data)
    cdef void tox_err_set_info_to_string(Tox* self, Tox_Err_Set_Info err_info_to_string)
    cdef void tox_err_set_typing_to_string(Tox* self, Tox_Err_Set_Typing err_typing_to_string)
    cdef void tox_err_conference_set_max_offline_to_string(Tox* self, Tox_Err_Conference_Set_Max_Offline err_conference_max_offline_to_string)
    cdef void tox_err_group_self_name_set_to_string(Tox* self, Tox_Err_Group_Self_Name_Set err_group_self_name_to_string)
    cdef void tox_err_group_self_status_set_to_string(Tox* self, Tox_Err_Group_Self_Status_Set err_group_self_status_to_string)
    cdef void tox_err_group_topic_set_to_string(Tox* self, Tox_Err_Group_Topic_Set err_group_topic_to_string)
    cdef void tox_err_group_set_password_to_string(Tox* self, Tox_Err_Group_Set_Password err_group_password_to_string)
    cdef void tox_err_group_set_topic_lock_to_string(Tox* self, Tox_Err_Group_Set_Topic_Lock err_group_topic_lock_to_string)
    cdef void tox_err_group_set_voice_state_to_string(Tox* self, Tox_Err_Group_Set_Voice_State err_group_voice_state_to_string)
    cdef void tox_err_group_set_privacy_state_to_string(Tox* self, Tox_Err_Group_Set_Privacy_State err_group_privacy_state_to_string)
    cdef void tox_err_group_set_peer_limit_to_string(Tox* self, Tox_Err_Group_Set_Peer_Limit err_group_peer_limit_to_string)
    cdef void tox_err_group_set_ignore_to_string(Tox* self, Tox_Err_Group_Set_Ignore err_group_ignore_to_string)
    cdef void tox_err_group_set_role_to_string(Tox* self, Tox_Err_Group_Set_Role err_group_role_to_string)
